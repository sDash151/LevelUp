    ...
    return (
      <>
        <motion.div 
          ...
          className="hidden lg:flex rounded-2xl p-5 mb-8 shadow-sm items-center justify-between" 
        ...
        <motion.div 
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          className="lg:hidden glass-card rounded-[20px] p-5 mb-5 shadow-elevated flex items-center justify-between" 
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-[12px] flex items-center justify-center bg-red-500/10">
              <Target className="w-5 h-5 text-red-500" />
            </div>
            <div className="flex flex-col gap-0.5">
              <h2 className="text-[14px] font-black tracking-tight text-[var(--th-text)] leading-none">Offline</h2>
              <p className="text-[11px] text-[var(--th-text-secondary)]">Tap retry to fetch insight</p>
            </div>
          </div>
          <button 
            onClick={() => regenerate.mutate()}
  ...
  return (
    <>
      ...
      <motion.div 
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        className="hidden lg:block rounded-2xl p-5 mb-8 shadow-sm relative overflow-hidden" 
        style={{ background: 'var(--th-card)', border: '1px solid var(--th-border)' }}
      >
